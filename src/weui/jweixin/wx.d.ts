...
/** 所有JS接口列表 */
export type ApiMethod = 'onMenuShareTimeline' |
...
/** 所有菜单基本类 */
export type MenuBase = 'menuItem:exposeArticle' |
    'menuItem:setFont' |
    'menuItem:dayMode' |
    'menuItem:nightMode' |
    'menuItem:refresh' |
...
/** 所有菜单传播类 */
export type MenuShare = 'menuItem:share:appMessage' |
...
/** 所有菜单保护类 */
export type MenuProtected = 'menuItem:editTag' |
    'menuItem:delete' |
    'menuItem:copyUrl' |
    'menuItem:originPage' |
    'menuItem:readMode' |
